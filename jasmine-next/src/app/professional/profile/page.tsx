...
export default function ProfessionalProfilePage() {
  const [name, setName] = useState('Dr. Jasmine');
  const [email, setEmail] = useState('dr.jasmine@jasmine.com');
  const [specialty, setSpecialty] = useState('Pediatric Specialist');
      ...
      <div className="p-6 bg-white dark:bg-dark-surface rounded-2xl border border-gray-200 dark:border-dark-deep">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-dark-deep">
            ...
            <span className="text-gray-900 dark:text-white font-medium">May 4, 2026</span>
          </div>
