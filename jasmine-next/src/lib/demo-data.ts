...
const DEMO_LINKS: DemoLink[] = [
  ...
  },
  {
    ...
    patientName: 'Aisha Bashabsheh',
    age: 5,
    dob: '2021-01-10',
    about: 'Aisha is a lively 5-year-old who enjoys music and dancing.',
    professionalId: DEMO_DOCTOR_ID,
    professionalName: 'Dr. Jasmine',
    parentId: 'demo-parent-sophia',
    parentEmail: 'mei.chen@example.com',
    parentName: 'Mohammad Al Jarrah',
    accessGranted: true,
