  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background-alt)' }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 space-y-16">
        ...
        {/* Disclaimer */}
        <section className="p-6 rounded-2xl" style={{ backgroundColor: 'var(--risk-moderate-bg)', border: '1px solid var(--risk-moderate)' }}>
        ...
        <section className="text-center">
          ...
          <p style={{ color: 'var(--text-muted)' }}>
            Built with <Heart className="w-4 h-4 inline" style={{ color: 'var(--risk-high)' }} /> by researchers and engineers 
