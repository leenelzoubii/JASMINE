...
export default function ProfessionalRequestsPage() {
  ...
  const statusConfig = {
    pending: { icon: Clock, label: 'Pending', bg: 'var(--risk-moderate-bg)', color: 'var(--risk-moderate)' },
    accepted: { icon: CheckCircle, label: 'Accepted', bg: 'var(--risk-low-bg)', color: 'var(--risk-low)' },
    declined: { icon: XCircle, label: 'Declined', bg: 'var(--risk-high-bg)', color: 'var(--risk-high)' },
  };
