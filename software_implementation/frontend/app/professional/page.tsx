    ...
    <div className="space-y-8">
      ...
      {patients.length === 0 && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <h2 className="text-lg font-semibold mb-3" style={{ color: 'var(--foreground)' }}>Getting Started 🚀</h2>
          <ol className="space-y-2 text-sm" style={{ color: 'var(--text-muted)' }}>
            <li><strong>1.</strong> Add your first patient in the <Link href="/professional/patients" className="text-primary hover:underline">Patients</Link> page</li>
            <li><strong>2.</strong> Run an ASD screening assessment from the <Link href="/professional/assessments" className="text-primary hover:underline">Assessments</Link> page</li>
            <li><strong>3.</strong> Review the results and share them with the parent</li>
            <li><strong>4.</strong> Discuss findings via the <Link href="/professional/messages" className="text-primary hover:underline">Messages</Link> page</li>
          </ol>
        </motion.div>
      )}
