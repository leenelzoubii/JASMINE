...
import { Send, Phone, Mail, Paperclip, Search } from 'lucide-react';
            ...
            <>
              <div className="p-4 flex items-center justify-between shrink-0" style={{ borderBottom: '1px solid var(--border)' }}>
                ...
                <div className="flex items-center gap-2">
                  <a href={`tel:${activeConnection?.phone || ''}`} className="p-2 rounded-lg" style={{ backgroundColor: 'var(--primary)', color: 'white' }}><Phone className="w-5 h-5" /></a>
                  <a href={`mailto:${activeConnection?.email || ''}`} className="p-2 rounded-lg" style={{ backgroundColor: 'var(--primary)', color: 'white' }}><Mail className="w-5 h-5" /></a>
                </div>
              </div>
              ...
              <div className="p-4 shrink-0" style={{ borderTop: '1px solid var(--border)' }}>
                <div className="flex items-center gap-3">
                  ...
                  <button onClick={() => fileInputRef.current?.click()} disabled={uploadingImage}
                    ...
                    style={{ backgroundColor: 'var(--background-alt)' }} title="Attach image">
                    {uploadingImage ? (
